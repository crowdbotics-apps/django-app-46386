"""
Django settings for django_app_46386 project.
...
ROOT_URLCONF = 'django_app_46386.urls'
...
WSGI_APPLICATION = 'django_app_46386.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "django_app_46386 API",
    "DESCRIPTION": "API documentation for django_app_46386 App",
    "VERSION": "v1",
}
